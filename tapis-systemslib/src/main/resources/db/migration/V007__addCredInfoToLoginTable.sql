...
--   TODO sync_status - enum indicating current status of synchronization between SK and Systems service.
...
--   TODO sync_fail_message -
--   TODO sync_fail_count -
-- Have all columns not null except has_credentials. Use has_credentials as a flag indicating values need to be
--    filled in from SK queries
...
ALTER TABLE systems_login_user ALTER COLUMN login_user DROP NOT NULL;
...
ALTER TABLE systems_login_user ADD COLUMN IF NOT EXISTS has_pki_keys boolean BOOLEAN NOT NULL DEFAULT false;
ALTER TABLE systems_login_user ADD COLUMN IF NOT EXISTS has_access_key boolean BOOLEAN NOT NULL DEFAULT false;
...
ALTER TABLE systems_login_user ADD COLUMN IF NOT EXISTS sync_status TEXT NOT NULL DEFAULT 'PENDING';
ALTER TABLE systems_login_user ADD COLUMN IF NOT EXISTS sync_fail_count INTEGER NOT NULL DEFAULT 0;
ALTER TABLE systems_login_user ADD COLUMN IF NOT EXISTS sync_fail_message TEXT;
