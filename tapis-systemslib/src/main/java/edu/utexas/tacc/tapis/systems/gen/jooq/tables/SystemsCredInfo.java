...
public class SystemsCredInfo extends TableImpl<SystemsCredInfoRecord> {
    ...
    /**
     * The column <code>tapis_sys.systems_cred_info.has_tms_keys</code>.
     */
    public final TableField<SystemsCredInfoRecord, Boolean> HAS_TMS_KEYS = createField(DSL.name("has_tms_keys"), SQLDataType.BOOLEAN.nullable(false).defaultValue(DSL.field("false", SQLDataType.BOOLEAN)), this, "");
