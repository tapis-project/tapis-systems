...
/** Parse, validate and massage MigrageJob parameters.
 * 
 * @author rcardone
 */
public class MigrageJobParameters
{
    /* ********************************************************************** */
    /*                               Constants                                */
    /* ********************************************************************** */
    // Tracing.
    private static final Logger _log = LoggerFactory.getLogger(MigrageJobParameters.class);
    ...
    /* constructor:                                                           */
    /* ---------------------------------------------------------------------- */
    public MigrageJobParameters(String[] args)
        ...
        throws TapisException
    {
         ...
         if (!help)
           {
            ...
            writer.write("MigrageJob [options...]\n");
      ...
      if (help)
        {
         String s = "\nMigrageJob for creating and deploying secrets to Kubernetes.";
