...
public class SystemsLoginUser extends TableImpl<SystemsLoginUserRecord> {
     ...
     */
    public final TableField<SystemsLoginUserRecord, LocalDateTime> CREATED = createField(DSL.name("created"), SQLDataType.LOCALDATETIME(6).nullable(false).defaultValue(DSL.field("(now() AT TIME ZONE 'utc'::text)", SQLDataType.LOCALDATETIME)), this, "");

    /**
     * The column <code>tapis_sys.systems_login_user.updated</code>.
     */
    public final TableField<SystemsLoginUserRecord, LocalDateTime> UPDATED = createField(DSL.name("updated"), SQLDataType.LOCALDATETIME(6).nullable(false).defaultValue(DSL.field("(now() AT TIME ZONE 'utc'::text)", SQLDataType.LOCALDATETIME)), this, "");
