...
public class SchedulerProfiles extends TableImpl<SchedulerProfilesRecord> {
     ...
     */
    public final TableField<SchedulerProfilesRecord, LocalDateTime> CREATED = createField(DSL.name("created"), SQLDataType.LOCALDATETIME(6).nullable(false).defaultValue(DSL.field("(now() AT TIME ZONE 'utc'::text)", SQLDataType.LOCALDATETIME)), this, "UTC time for when record was created");

    /**
     * The column <code>tapis_sys.scheduler_profiles.updated</code>. UTC time
     * for when record was last updated
     */
    public final TableField<SchedulerProfilesRecord, LocalDateTime> UPDATED = createField(DSL.name("updated"), SQLDataType.LOCALDATETIME(6).nullable(false).defaultValue(DSL.field("(now() AT TIME ZONE 'utc'::text)", SQLDataType.LOCALDATETIME)), this, "UTC time for when record was last updated");
