...
public class Keys {
    ...
    public static final UniqueKey<SystemsHistoryRecord> SYSTEMS_HISTORY_PKEY = Internal.createUniqueKey(SystemsHistory.SYSTEMS_HISTORY, DSL.name("systems_history_pkey"), new TableField[] { SystemsHistory.SYSTEMS_HISTORY.SEQ_ID }, true);

    // -------------------------------------------------------------------------
    // FOREIGN KEY definitions
    // -------------------------------------------------------------------------

    public static final ForeignKey<SystemsHistoryRecord, SystemsRecord> SYSTEMS_HISTORY__SYSTEMS_HISTORY_SYSTEM_SEQ_ID_FKEY = Internal.createForeignKey(SystemsHistory.SYSTEMS_HISTORY, DSL.name("systems_history_system_seq_id_fkey"), new TableField[] { SystemsHistory.SYSTEMS_HISTORY.SYSTEM_SEQ_ID }, Keys.SYSTEMS_PKEY, new TableField[] { Systems.SYSTEMS.SEQ_ID }, true);
}
