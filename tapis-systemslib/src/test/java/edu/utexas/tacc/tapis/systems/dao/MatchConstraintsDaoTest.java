...
//  private static final String hostName7 = "host" + testKey + "_007";
  ...
  public void setup() throws Exception
  {
    ...
    Thread.sleep(500);
    boolean itemCreated = dao.createSystem(rUser, dtnSystem1, gson.toJson(dtnSystem1), rawDataEmptyJson);
    Assert.assertTrue(itemCreated, "Item not created, id: " + dtnSystem1.getId());
    allowedIDs.add(dtnSystem1.getId());
    for (TSystem sys : systems)
    {
      itemCreated = dao.createSystem(rUser, sys, gson.toJson(sys), rawDataEmptyJson);
