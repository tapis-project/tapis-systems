...
public class SystemsServiceTest
{
  ...
  public void testGetSystem() throws Exception
  {
    ...
    tmpSys = svc.getSystem(rFilesSvcOwner1, sys0.getId(), null, false, true, null, sharedCtxNull, resourceTenantNull);
    checkCommonSysAttrs(sys0, tmpSys);
    ...
    tmpSys = svc.getSystem(rFilesSvcOwner1, sys0.getId(), AuthnMethod.PASSWORD, false, true, null, sharedCtxNull, resourceTenantNull);
    System.out.println("Found item: " + sys0.getId());
  ...
  public void testPutSystem() throws Exception
  {
    ...
    TSystem tmpSys = svc.getSystem(rOwner1, systemId, null, false, false, null, sharedCtxNull, resourceTenantNull);
    ...
    tmpSys = svc.getSystem(rOwner1, sys0.getId(), null, false, false, null, sharedCtxNull, resourceTenantNull);
  ...
  public void testPatchSystem() throws Exception
  {
    ...
    TSystem tmpSysFull = svc.getSystem(rOwner1, systemId, null, false, false, null, sharedCtxNull, resourceTenantNull);
    ...
    TSystem tmpSysPartial = svc.getSystem(rOwner1, systemId, null, false, false, null, sharedCtxNull, resourceTenantNull);
  ...
  public void testChangeSystemOwner() throws Exception
  {
    ...
    TSystem tmpSys = svc.getSystem(rTestUser2, sys0.getId(), null, false, false, null, sharedCtxNull, resourceTenantNull);
    ...
    try {
      svc.getSystem(rOwner1, sys0.getId(), null, false, false, null, sharedCtxNull, resourceTenantNull);
...
//    tmpSys = svc.getSystem(rOwner1, sys0.getId(), null, false, false, null, resolveTypeALL, sharedCtxNull, resourceTenantNull);
...
//  }
  ...
  public void testEnableDisableDeleteUndelete() throws Exception
  {
    ...
    TSystem tmpSys = svc.getSystem(rOwner1, sysId, null, false, false, null, sharedCtxNull, resourceTenantNull);
    ...
    tmpSys = svc.getSystem(rOwner1, sysId, null, false, false, null, sharedCtxNull, resourceTenantNull);
  ...
  public void testUserCredentials() throws Exception
  {
    ...
    TSystem tmpSys = svc.getSystem(rFilesSvcOwner1, sysId, AuthnMethod.PASSWORD, false, getCredsTrue, null, sharedCtxNull, resourceTenantNull);
    ...
    tmpSys = svc.getSystem(rFilesSvcTestUser3, sysId, AuthnMethod.PASSWORD, false, getCredsTrue, null, sharedCtxNull, resourceTenantNull);
    ...
    tmpSys = svc.getSystem(rFilesSvcTestUser3, sysId, AuthnMethod.PASSWORD, requireExecPermFalse, getCredsTrue,
                           testUser4, sharedCtxNull, resourceTenantNull);
    checkCredPasswordAndEffectiveUser(tmpSys, cred4LoginUser.getPassword(), testUser4, testUser4LinuxUser);
    ...
    tmpSys = svc.getSystem(rFilesSvcOwner1, sysId, AuthnMethod.PASSWORD, false, getCredsTrue, null, sharedCtxNull, resourceTenantNull);
    ...
    tmpSys = svc.getSystem(rFilesSvcTestUser5, sysId, AuthnMethod.PASSWORD, false, getCredsTrue, null, sharedCtxNull, resourceTenantNull);
  ...
  public void testUserCredentialsStaticEffUser() throws Exception
  {
    ...
    TSystem tmpSys = svc.getSystem(rFilesSvcOwner1, sys0.getId(), AuthnMethod.PASSWORD, requireExecPermFalse,
                                   getCredsTrue, impersonationIdNull, sharedCtxNull, resourceTenantNull);
  ...
  public void testMissingSystem() throws Exception
  {
    ...
    TSystem tmpSys = svc.getSystem(rOwner1, fakeSystemName, null, false, false, null, sharedCtxNull, resourceTenantNull);
  ...
  public void testAuthDeny() throws Exception
  {
    ...
    pass = false;
    try { svc.getSystem(rTestUser0, systemId, null, false, false, null, sharedCtxNull, resourceTenantNull); }
    catch (ForbiddenException e)
    {
      Assert.assertTrue(e.getMessage().startsWith("SYSLIB_UNAUTH"));
      pass = true;
    ...
    pass = false;
    try { svc.getSystem(rTestUser3, systemId, null, true, false, null, sharedCtxNull, resourceTenantNull); }
    catch (ForbiddenException e)
    {
      Assert.assertTrue(e.getMessage().startsWith("SYSLIB_UNAUTH"));
      pass = true;
...
//    Assert.assertTrue(pass);
    ...
    pass = false;
    try { svc.getSystem(rTestUser1, systemId, null, false, false, owner1, sharedCtxNull, resourceTenantNull); }
    catch (ForbiddenException e)
    {
    ...
    pass = false;
    try { svc.getSystem(rFilesSvcTestUser3, systemId, null, false, false, impersonationIdTestUser9, sharedCtxNull, resourceTenantNull); }
    catch (ForbiddenException e)
    {
      Assert.assertTrue(e.getMessage().startsWith("SYSLIB_UNAUTH"));
      pass = true;
    ...
    pass = false;
    try { svc.getSystem(rTestUser1, systemId, null, false, false, impersonationIdNull, sharedCtxOwner, resourceTenantNull); }
    catch (ForbiddenException e)
    {
    ...
    pass = false;
    try { svc.getSystem(rAppsSvcTestUser1, systemId, null, false, false, impersonationIdNull, sharedCtxOwner, resourceTenantNull); }
    catch (ForbiddenException e)
    {
      Assert.assertTrue(e.getMessage().startsWith("SYSLIB_UNAUTH_SHAREDAPPCTX"));
      pass = true;
  ...
  public void testAuthAllow() throws Exception
  {
    ...
    svc.getSystem(rOwner1, sys0.getId(), null, false, false, null, sharedCtxNull, resourceTenantNull);
    svc.getSystem(rOwner1, sys0.getId(), null, true, false, null, sharedCtxNull, resourceTenantNull);
    svc.getSystem(rFilesSvcOwner1, sys0.getId(), null, false, false, null, sharedCtxNull, resourceTenantNull);
    svc.getSystem(rTestUser3, sys0.getId(), null, false, false, null, sharedCtxNull, resourceTenantNull);
    svc.getSystem(rTestUser3, sys0.getId(), null, true, false, null, sharedCtxNull, resourceTenantNull);
    svc.getSystem(rTestUser2, sys0.getId(), null, false, false, null, sharedCtxNull, resourceTenantNull);
    // Files should be allowed to impersonate another user
    svc.getSystem(rFilesSvcTestUser3, sys0.getId(), null, false, false, owner1, sharedCtxNull, resourceTenantNull);
    // Jobs and Files should be allowed to set sharedAppCtx
    svc.getSystem(rJobsSvcOwner1, sys0.getId(), null, false, false, impersonationIdNull, sharedCtxOwner, resourceTenantNull);
    svc.getSystem(rFilesSvcTestUser3, sys0.getId(), null, false, false, impersonationIdNull, sharedCtxOwner, resourceTenantNull);

    // When a service impersonates another user it should be allowed if sharedAppCtx set to true even if normally denied.
    svc.getSystem(rFilesSvcTestUser3, sys0.getId(), null, false, false, impersonationIdTestUser9, sharedCtxOwner, resourceTenantNull);
  }
  ...
  public void testGetSystemHistoryMultipleUpdates() throws Exception
  {
    ...
    TSystem tmpSys = svc.getSystem(ownerUser, sysId, null, false, false, null, sharedCtxNull, resourceTenantNull);
    // Get last updated timestamp
    LocalDateTime updated = LocalDateTime.ofInstant(tmpSys.getUpdated(), ZoneOffset.UTC);
    String updatedStr1 = TapisUtils.getSQLStringFromUTCTime(updated);
    // Pause briefly to make sure updated timestamp changes for patch
  ...
  public void testShareSystem() throws Exception
  {
   ...
   // Verify that isPublic field is set correctly when fetching system.
    TSystem tmpSys = svc.getSystem(rTestUser5, sysId, null, false, false, null, sharedCtxNull, resourceTenantNull);
