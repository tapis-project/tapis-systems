...
public class SystemsServiceTest
{
  ...
  public void testCredCheckS3() throws Exception
  {
    ...
    Assert.assertEquals(checkedCred.getValidationResult(), Boolean.TRUE);
    checkedCred = svcCred.checkUserCredential(rOwner1, sys0.getId(), targetUser, AuthnMethod.ACCESS_KEY);
    Assert.assertEquals(checkedCred.getValidationResult(), Boolean.TRUE);
  ...
  public void testGetSystems() throws Exception
  {
    ...
    List<TSystem> systems = svc.getSystems(rOwner1, searchListNull, limitNone, orderByListNull, skipZero,
                                           startAferEmpty, showDeletedFalse, listTypeNull, fetchShareInfoFalse, hasCredentialsNull, impersonationIdNull);
  ...
  public void testGetSystemsByListType() throws Exception
  {
    ...
    systems = svc.getSystems(rOwner3, searchListNull, limitNone, orderByListNull, skipZero, startAferEmpty,
            showDeletedFalse, listTypeOwned.name(), fetchShareInfoFalse, hasCredentialsNull, impersonationIdNull);
    ...
    systems = svc.getSystems(rOwner3, searchListNull, limitNone, orderByListNull, skipZero, startAferEmpty,
            showDeletedFalse, listTypePublic.name(), fetchShareInfoFalse, hasCredentialsNull, impersonationIdNull);
    Assert.assertNotNull(systems, "Returned list of systems should not be null");
    ...
    // ALL - should return 4
    systems = svc.getSystems(rOwner3, searchListNull, limitNone, orderByListNull, skipZero, startAferEmpty,
            showDeletedFalse, listTypeAll.name(), fetchShareInfoFalse, hasCredentialsNull, impersonationIdNull);
    Assert.assertNotNull(systems, "Returned list of systems should not be null");
    ...
    systems = svc.getSystems(rAdminUser, searchListNull, limitNone, orderByListNull, skipZero, startAferEmpty,
                             showDeletedFalse, listTypeAll.name(), fetchShareInfoFalse, hasCredentialsNull, owner5);
    Assert.assertNotNull(systems, "Returned list of systems should not be null");
    System.out.printf("getSystems returned %d items using listType = %s%n", systems.size(), listTypeAll);
 ...
 */
  ...
  public void testUserCredentialsStaticEffUser() throws Exception
  {
    ...
    cred0 = svcCred.getUserCredential(rFilesSvcOwner1, sys0.getId(), effectiveUserId1, AuthnMethod.PASSWORD);
    Assert.assertNotNull(cred0, "AuthnCredential should not be null");
    Assert.assertEquals(cred0.getAuthnMethod(), AuthnMethod.PASSWORD);
    Assert.assertNotNull(cred0.getPassword(), "AuthnCredential password should not be null");
    Assert.assertEquals(cred0.getPassword(), cred1.getPassword());
    ...
    cred0 = svcCred.getUserCredential(rFilesSvcOwner1, sys0.getId(), owner1, AuthnMethod.PASSWORD);
  ...
  public void testMissingSystem() throws Exception
  {
    ...
    Credential cred = svcCred.getUserCredential(rOwner1, fakeSystemName, fakeUserName, AuthnMethod.PKI_KEYS);
    ...
    changeCount = svcCred.deleteUserCredential(rOwner1, fakeSystemName, fakeUserName);
...
//    Assert.assertTrue(pass);
    ...
    pass = false;
    try { svcCred.deleteUserCredential(rTestUser3, systemId, owner1); }
    catch (ForbiddenException e)
    {
      Assert.assertTrue(e.getMessage().startsWith("SYSLIB_UNAUTH"));
      pass = true;
    ...
    Assert.assertTrue(pass);
//    pass = false;
//    try { svcCred.deleteUserCredential(rFilesSvcOwner1, systemId, owner1); }
//    catch (ForbiddenException e)
//    {
//      Assert.assertTrue(e.getMessage().startsWith("SYSLIB_UNAUTH"));
//      pass = true;
...
//    Assert.assertTrue(pass);
    ...
    pass = false;
    try { svcCred.getUserCredential(rTestUser3, systemId, owner1, null); }
    catch (ForbiddenException e)
    {
    ...
    Assert.assertTrue(pass);
    pass = false;
    try { svcCred.getUserCredential(rOwner1, systemId, owner1, null); }
    catch (ForbiddenException e)
    {
      Assert.assertTrue(e.getMessage().startsWith("SYSLIB_UNAUTH_GETCRED"));
      pass = true;
  ...
  public void testAuthAllow() throws Exception
  {
    ...
    svc.getSystems(rAdminUser, searchListNull, limitNone, orderByListNull, skipZero, startAfterNull, false,
                   listTypeNull, fetchShareInfoFalse, hasCredentialsNull, testUser3);
  }
  ...
  public void testUnlinkChildren() throws TapisException, TapisClientException {
    ...
    List<TSystem>  childSystems = svc.getSystems(rParentChild1, Arrays.asList("parentId.eq." + createdParent.getId()),
            -1, null, 0, null, false, null, fetchShareInfoFalse, hasCredentialsNull, impersonationIdNull);
    ...
    childSystems = svc.getSystems(rParentChild1, Arrays.asList("parentId.eq." + createdParent.getId()), -1,
            null, 0, null, false, null, fetchShareInfoFalse, hasCredentialsNull, impersonationIdNull);
